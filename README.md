...
Webia is a local, open-source AI app builder. It's fast, private, and fully under your control — like Lovable, v0, or Bolt, but running right on your machine.
...
**Webia** is open-source (Apache 2.0 licensed).

If you're interested in contributing to webia, please read our [contributing](./CONTRIBUTING.md) doc.
